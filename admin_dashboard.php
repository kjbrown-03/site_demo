...
<head>
    ...
    <title>Tableau de Bord Admin - ImmoHome</title>
...
<body>
    ...
    <section class="admin-hero">
        <div class="container">
            ...
            <p>Gérez les utilisateurs, propriétés et commandes</p>
        </div>
    </section>
    ...
    <section class="admin-content">
        <div class="container">
            ...
            <div class="admin-tabs">
                ...
                <button class="tab-btn" data-tab="properties">Propriétés</button>
            ...
            <div class="tab-content active" id="users-tab">
                <div class="section-header">
                    ...
                    <button class="btn-primary" onclick="showAddUserForm()">Ajouter un Utilisateur</button>
                </div>
                ...
                <div class="add-form" id="add-user-form" style="display: none;">
                    ...
                    <form method="POST">
                        ...
                        <button type="button" class="btn-secondary" onclick="hideAddUserForm()">Annuler</button>
                    </form>
                </div>
            ...
            <div class="tab-content" id="properties-tab">
                <div class="section-header">
                    ...
                    <button class="btn-primary" onclick="showAddPropertyForm()">Ajouter une Propriété</button>
                </div>
                ...
                <div class="history-sections">
                    <div class="history-card">
                        <div class="history-header">
                            <h3><i class="fas fa-users"></i> Historique des Utilisateurs</h3>
                        </div>
                        <div class="table-container">
                            <table class="admin-table">
                                <thead>
                    ...
                    <div class="history-card">
                        <div class="history-header">
                            <h3><i class="fas fa-home"></i> Historique des Propriétés</h3>
                        </div>
                        <div class="table-container">
                            <table class="admin-table">
                                <thead>
                    ...
                    <div class="history-card">
                        <div class="history-header">
                            <h3><i class="fas fa-file-invoice"></i> Historique des Commandes</h3>
                        </div>
                        <div class="table-container">
                            <table class="admin-table">
                                <thead>
