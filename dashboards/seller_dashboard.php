...
<head>
    ...
    <title><?php echo t('seller_dashboard'); ?> - ImmoHome</title>
...
<body class="<?php echo $currentTheme; ?>">
    <header>
        <nav class="navbar">
            <div class="container">
                ...
                <ul class="nav-links">
                    <li><a href="seller_dashboard.php" class="active"><?php echo t('dashboard'); ?></a></li>
                    <li><a href="../user/my_properties.php"><?php echo t('my_properties_title'); ?></a></li>
                    <li><a href="../pages/add_property.php"><?php echo t('add'); ?></a></li>
    ...
    <section class="dashboard-hero">
        <div class="container">
            <h1><?php echo t('seller_dashboard'); ?></h1>
            <p><?php echo t('manage_properties_sales'); ?></p>
        </div>
    </section>
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        <h3><?php echo t('my_properties_title'); ?></h3>
                        <p><?php echo t('manage_real_estate'); ?></p>
                    </div>
                    <a href="../user/my_properties.php" class="stat-action">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        ...
                        <p><?php echo t('add_new_property'); ?></p>
                    </div>
                    <a href="../pages/add_property.php" class="stat-action">
                        <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        <h3><?php echo t('my_sales_title'); ?></h3>
                        <p><?php echo t('track_sales_performance'); ?></p>
                    </div>
                    <a href="../user/my_sales.php" class="stat-action">
                        <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        <h3><?php echo t('market_insights'); ?></h3>
                        <p><?php echo t('view_market_trends'); ?></p>
                    </div>
    ...
    <section class="recent-properties">
        <div class="container">
            <div class="section-header">
                <h2><?php echo t('your_listed_properties'); ?></h2>
                <p><?php echo t('recently_added_listings'); ?></p>
            </div>
