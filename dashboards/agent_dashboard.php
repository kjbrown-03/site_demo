...
<head>
    ...
    <title><?php echo t('agent_dashboard'); ?> - ImmoHome</title>
...
<body class="<?php echo $currentTheme; ?>">
    ...
    <section class="dashboard-hero">
        <div class="container">
            <h1><?php echo t('agent_dashboard'); ?></h1>
            <p><?php echo t('manage_listings_clients'); ?></p>
        </div>
    </section>
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        <h3><?php echo t('my_listings_title'); ?></h3>
                        <p><?php echo t('manage_listings'); ?></p>
                    </div>
                    <a href="../agent/my_listings.php" class="stat-action">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        <h3><?php echo t('prospects_title'); ?></h3>
                        <p><?php echo t('manage_prospects'); ?></p>
                    </div>
                    <a href="../agent/client_leads.php" class="stat-action">
                        <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        <h3><?php echo t('appointments_title'); ?></h3>
                        <p><?php echo t('manage_appointments'); ?></p>
                    </div>
                    <a href="../agent/appointments.php" class="stat-action">
                        <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-content">
                        <h3><?php echo t('performance_title'); ?></h3>
                        <p><?php echo t('track_sales_metrics'); ?></p>
                    </div>
    ...
    <section class="recent-properties">
        <div class="container">
            <div class="section-header">
                <h2><?php echo t('recent_listings'); ?></h2>
                <p><?php echo t('newly_added_properties'); ?></p>
            </div>
