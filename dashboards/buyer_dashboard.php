    ...
    <header>
        <nav class="navbar">
            <div class="container">
                ...
                <ul class="nav-links">
                    <li><a href="buyer_dashboard.php" class="active"><?php echo t('dashboard'); ?></a></li>
                    <li><a href="../pages/search_properties.php"><?php echo t('search'); ?></a></li>
                    <li><a href="../user/my_orders.php"><?php echo t('my_orders'); ?></a></li>
