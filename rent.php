...
// Get rental properties from database
try {
    $stmt = $pdo->prepare("SELECT p.*, u.username as agent_name FROM properties p LEFT JOIN users u ON p.agent_id = u.id WHERE p.status = 'for_rent' ORDER BY p.created_at DESC");
    $stmt->execute();
...
<body class="<?php echo $currentTheme; ?>">
    ...
    <section class="properties-results">
        <div class="container">
            <div class="section-header">
                ...
                <p><?php echo count($properties); ?> <?php echo t('properties_available'); ?></p>
            </div>
                        ...
                        <div class="property-card" data-property-id="<?php echo $property['id']; ?>">
                            ...
                            <div class="property-info">
                                ...
                                <div class="property-actions">
                                    <button class="btn-secondary" onclick="viewProperty(<?php echo $property['id']; ?>)"><?php echo t('view_details'); ?></button>
    ...
    <script>
        ...
        function viewProperty(propertyId) {
            alert('<?php echo t('property_details'); ?> ID: ' + propertyId);
