...
<head>
    ...
    <title>Buyer Dashboard - ImmoHome</title>
...
<body>
    <header>
        <nav class="navbar">
            <div class="container">
                ...
                <ul class="nav-links">
                    <li><a href="buyer_dashboard.php" class="active">Dashboard</a></li>
    ...
    <section class="dashboard-hero">
        <div class="container">
            ...
            <p>Find your dream property and manage your purchases</p>
        </div>
    </section>
        ...
        <div class="container">
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <a href="search_properties.php" class="stat-action">
                ...
                <div class="stat-card">
                    ...
                    <a href="favorites.php" class="stat-action">
                        <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <a href="my_orders.php" class="stat-action">
                        <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <a href="account_settings.php" class="stat-action">
                        <i class="fas fa-arrow-right"></i>
                    </a>
                </div>
            </div>
